...
class OIDCProvider:  # pylint:disable=too-many-instance-attributes
    ...
    def present_login_options_or_authorize(
        ...
        return self._authorize(
            request, authorize_request, login_options[0], auth_session
        )
    ...
    def _authorize(
        ...
        if auth_session:
            return self.authorize_with_active_session(
    ...
    def handle_external_authentication(
        ...
        auth_req = authentication_context.authorization_request

        acs_context = AcsContext(
            client_id=authentication_context.authorization_request["client_id"],
            authentication_method=authentication_context.authentication_method,
            userinfo=userinfo,
        )
    ...
    def authorize_with_active_session(
        ...
        pyop_authorization_response = self.py_op_authorize(authorization_request)
        userinfo = self._userinfo_service.request_userinfo_for_session(auth_session)
        self._authentication_cache.cache_acs_context(
