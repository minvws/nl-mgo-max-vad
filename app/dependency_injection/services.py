...
class Services(containers.DeclarativeContainer):
    ...
    auth_session_encrypter = providers.Singleton(
        AuthSessionEncrypter,
        encrypter=encryption_services.auth_session_encrypter,
    )

    auth_session_cookie_builder = providers.Singleton(
        AuthSessionCookieBuilder,
        auth_session_encrypter=auth_session_encrypter,
        auth_session_cache=storage.auth_session_cache,
        enforce_secure_cookie=config.uvicorn.use_ssl.as_(as_bool),
        cookie_expiry_offset_seconds=config.auth_session.cookie_expiry_offset_seconds.as_int(),
    )
    ...
    auth_session_resolver = providers.Singleton(
        AuthSessionResolver,
        auth_session_cache=storage.auth_session_cache,
        auth_session_encrypter=auth_session_encrypter,
    )
